...
stayInProgram=True
res=False
commands = ['help','listClients','popShell', 'sendFile', 'reciveFile', 'execProgram', 'install','runComand', 'testServer', 'testClient','exit']
...
while stayInProgram :
    ...
    if (command == 0): #help
        ...
        "9 - testClient: tests the connection on the client machine."  + "\n\n" +
...
#lC:ok,pS:no,sF:no,rF:no,eP:no,i:no,rC:no,tS:ok,tC:no
